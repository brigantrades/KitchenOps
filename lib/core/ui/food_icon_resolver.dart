...
const List<({String needle, String assetName})> _keywordAssetPairs = [
  ...
  (needle: 'sweet potatoes', assetName: 'sweet_potato'),
  ...
  (needle: 'chicken wing', assetName: 'poultry'),
  (needle: 'chicken wings', assetName: 'poultry'),
  ...
  (needle: 'green beans', assetName: 'broccoli'),
  (needle: 'green bean', assetName: 'broccoli'),
  (needle: 'pizza dough', assetName: 'pizza'),
  (needle: 'bread crumbs', assetName: 'bread_loaf'),
  (needle: 'cream cheese', assetName: 'cheese'),
  (needle: 'sour cream', assetName: 'milk'),
  (needle: 'pork chop', assetName: 'meat'),
  (needle: 'granola', assetName: 'wheat'),
  (needle: 'cereal', assetName: 'wheat'),
  (needle: 'sausage', assetName: 'meat'),
  (needle: 'tortillas', assetName: 'burrito'),
  (needle: 'salsa', assetName: 'tomato'),
  ...
  (needle: 'oranges', assetName: 'tangerine'),
