...
class GroceryRepository {
  ...
  static const Map<String, GroceryCategory> _categoryMap = {
    ...
    // Spices & dried herbs (Produce; store layout / user preference).
    'garam masala': GroceryCategory.produce,
    'chili powder': GroceryCategory.produce,
    'curry powder': GroceryCategory.produce,
    'curry paste': GroceryCategory.produce,
    'bay leaves': GroceryCategory.produce,
    'bay leaf': GroceryCategory.produce,
    'star anise': GroceryCategory.produce,
    'black pepper': GroceryCategory.produce,
    'white pepper': GroceryCategory.produce,
    'peppercorn': GroceryCategory.produce,
    'pumpkin spice': GroceryCategory.produce,
    'turmeric': GroceryCategory.produce,
    'cumin': GroceryCategory.produce,
    'coriander': GroceryCategory.produce,
    'paprika': GroceryCategory.produce,
    'cinnamon': GroceryCategory.produce,
    'nutmeg': GroceryCategory.produce,
    'cloves': GroceryCategory.produce,
    'cayenne': GroceryCategory.produce,
    ...
    'chipotle': GroceryCategory.produce,
    'vanilla': GroceryCategory.produce,
    'cardamom': GroceryCategory.produce,
    'allspice': GroceryCategory.produce,
    'fennel seed': GroceryCategory.produce,
    'fennel': GroceryCategory.produce,
